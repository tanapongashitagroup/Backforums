...
@Component({
  selector: 'app-ads4',
  templateUrl: './ads4.component.html',
  styleUrls: ['./ads4.component.css']
})
export class Ads4Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cropCover.width = 640; // ตัว crop
    this.cropCover.height = 320;
    this.cropCover.croppedWidth = 640;  // ขนาดรูปที่ save ออกมา
    this.cropCover.croppedHeight = 320;
