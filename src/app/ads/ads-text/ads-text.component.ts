...
@Component({
  selector: 'app-ads-text',
  templateUrl: './ads-text.component.html',
  styleUrls: ['./ads-text.component.css']
})
export class AdsTextComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.cropCover.width = 300; // ตัว crop
    this.cropCover.height = 300;
    this.cropCover.croppedWidth = 640;  // ขนาดรูปที่ save ออกมา
    this.cropCover.croppedHeight = 640;
